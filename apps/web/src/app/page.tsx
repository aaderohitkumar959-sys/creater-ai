    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] via-[#13111c] to-[#0a0a0f] text-white overflow-hidden">
      ...
      <div className="relative z-10 pb-20">
        ...
        <div className="pt-16 pb-8 px-6 flex flex-col items-center">
          ...
          {/* Tagline */}
          <p className="mt-6 text-lg text-gray-400 text-center max-w-md leading-relaxed">
        ...
        {/* Footer */}
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#0a0a0f] via-[#0a0a0f]/90 to-transparent pointer-events-none">
